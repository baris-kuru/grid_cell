...
'''this function splits the signal into bins with the defined size & calculates correlation 
for between different trajectories with bins either for the activation profile produced or 
inh poisson time stamps created'''
...
''' this function takes 2d ndarray with time stamp arrays and 
counts time stamps in one specified bin in the function'''  
