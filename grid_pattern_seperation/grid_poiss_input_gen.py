...
def inhom_poiss(arr, n_traj, dt_s=0.025, speed_cm = 20, field_size_cm = 100, seed=10000):
    ...
    for grid_idc in range(n_cells):
        for i in range(n_traj):
            ...
            #generate teh spike train out of analog signal
            curr_train = stg.inhomogeneous_poisson_process(asig)
            spi_arr[grid_idc, i] = curr_train.times*1000 #time conv to ms
    return spi_arr
