...
data = np.load("rate_n_phase_codes_perceptron_500ms_net-seeds_410-419.npz", allow_pickle=True)
...
plt.title('Threshold Crossing for Grid Codes in 500ms')
parameters = ('lr = 5*$10^{-5}$,  10 Grid seeds, 5 Poisson seeds,'+ 
...
plt.title('Threshold Crossing for Granule Codes in 500ms')
